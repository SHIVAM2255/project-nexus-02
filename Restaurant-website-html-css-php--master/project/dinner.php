 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="dinner.php"</script>';  
           }  
      }  
      else  
      {  
...
<title>food bazzar Traditional Restaurant | Menu</title>   
      ...
      <body>  
           ...
           <div class="container" style="width:700px align="center";">  
                ...
                <?php  
                $query = "SELECT * FROM Dinner ORDER BY food_id ASC";  
                ...
                ?>  
                <div class="col-md-4" >  
                     <form method="post" action="dinner.php?action=add&id=<?php echo $row["food_id"]; ?>">  
				...
				<caption >ORDER DETAILS</caption>
                          ...
                          <tr>  
                               ...
                               <td><a href="dinner.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
